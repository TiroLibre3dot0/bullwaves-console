      ...
      en: makeLocaleVariants(
        {
          ...
          subject:
            'Your Bullwaves account is ready. Completing your first deposit is the natural next step.',
          html: {
            lang: 'en',
            skin: 'dark',
            title: 'Complete your first deposit',
            heroTitle: 'One step away from full access',
            heroSubtitle: 'Complete your first deposit and unlock the <strong>platform</strong>.',
            mainTitle: 'Everything is in place. Only the first deposit remains.',
            introLead:
              'Your account is configured. The next stage begins with the <strong>first deposit</strong>.',
            bodyOne: 'This is the right moment to move from preparation into activation.',
            bodyTwo: 'What this step unlocks for you:',
            boxOneTitle: 'Activation',
            boxOneCopy: 'Move beyond setup',
            boxTwoTitle: 'Access',
            boxTwoCopy: 'Unlock the full environment',
            boxThreeTitle: 'Support',
            boxThreeCopy: 'Available if a blocker appears',
            ...UNFUNDED_ICON_SETS.depositPush,
            bodyThree: 'A timely first deposit keeps the path simple and uninterrupted.',
            bodyFour: 'If one practical issue remains, it can be resolved quickly.',
            ctaLabel: 'Complete Your First Deposit',
            ctaHelper: 'Open the platform and complete the deposit step',
          },
        },
        {
          ...
          subject: 'Your setup is complete. The first deposit is the only step remaining.',
          html: {
            lang: 'en',
            skin: 'light',
            title: 'Keep the process moving',
            heroTitle: 'Preserve your momentum',
            heroSubtitle:
              'The next step is easiest while your setup is still <strong>fresh</strong>.',
            mainTitle: 'The account is ready. The best next move is to complete the deposit step.',
            introLead:
              'You already completed the setup work. Finishing the deposit now keeps the path <strong>light</strong> and orderly.',
            bodyOne:
              'The simplest move is often the right one: return, complete the deposit, and move forward with clarity.',
            bodyTwo: 'What matters most at this stage:',
            boxOneTitle: 'Continuity',
            boxOneCopy: 'Keep the process active',
            boxTwoTitle: 'Progress',
            boxTwoCopy: 'Move into activation',
            boxThreeTitle: 'Support',
            boxThreeCopy: 'Available if needed',
            ...UNFUNDED_ICON_SETS.depositMomentum,
            bodyThree:
              'This is not a new decision. It is the natural completion of the path you already started.',
            bodyFour: 'If one specific blocker remains, WhatsApp can help you remove it quickly.',
            ctaLabel: 'Finish the Funding Step',
            ctaHelper: 'Return to the platform and complete the deposit',
          },
        }
      ),
      it: makeLocaleVariants(
        {
          ...
          subject:
            'Il tuo account Bullwaves è pronto. Completare il primo deposito è il passo naturale per proseguire.',
          html: {
            lang: 'it',
            skin: 'dark',
            ...
            mainTitle: 'È tutto pronto. Resta solo il primo deposito.',
            introLead:
              'Il tuo account è configurato. La fase successiva inizia con il <strong>primo deposito</strong>.',
            bodyOne: "Questo è il momento giusto per passare dalla preparazione all'attivazione.",
            bodyTwo: 'Cosa sblocca questo passaggio:',
            boxOneTitle: 'Attivazione',
            boxOneCopy: 'Vai oltre il setup',
            boxTwoTitle: 'Accesso',
            boxTwoCopy: 'Sblocca l ambiente completo',
            boxThreeTitle: 'Supporto',
            boxThreeCopy: 'Disponibile se emerge un blocco',
            ...UNFUNDED_ICON_SETS.depositPush,
            bodyThree: 'Un primo deposito fatto al momento giusto rende il percorso più lineare.',
            bodyFour: 'Se resta un tema pratico, può essere risolto rapidamente.',
            ctaLabel: 'Completa il Primo Deposito',
            ctaHelper: 'Apri la piattaforma e completa il deposito',
          },
        },
        {
          ...
          subject: 'La configurazione è completa. Resta solo il primo deposito.',
          html: {
            lang: 'it',
            skin: 'light',
            title: 'Mantieni il processo in movimento',
            heroTitle: 'Proteggi lo slancio',
            heroSubtitle:
              'Il prossimo passo è più facile finché la configurazione è <strong>fresca</strong>.',
            mainTitle: 'L account è pronto. La mossa più ordinata ora è completare il deposito.',
            introLead:
              'Hai già completato la configurazione. Finire ora il deposito rende il percorso più <strong>lineare</strong> e leggero.',
            bodyOne:
              'Spesso la mossa più semplice è anche la migliore: rientrare, completare il deposito e andare avanti con chiarezza.',
            bodyTwo: 'Cosa conta di più in questa fase:',
            boxOneTitle: 'Continuità',
            boxOneCopy: 'Mantieni attivo il processo',
            boxTwoTitle: 'Progresso',
            ...
            ...UNFUNDED_ICON_SETS.depositMomentum,
            bodyThree:
              'Non è una nuova decisione. È il completamento naturale del percorso che hai già avviato.',
            bodyFour: 'Se resta un blocco preciso, WhatsApp può aiutarti a rimuoverlo rapidamente.',
            ctaLabel: 'Completa il Deposito',
            ctaHelper: 'Rientra in piattaforma e completa il deposito',
          },
        }
      ),
    },
