...
export const sendgridTemplateRegistryGeneratedAt = '2026-04-14T13:50:52.367Z'
  ...
  churned_high_value_followup_recovery_email: {
    ...
    it: {
      a: {
        ...
        subject:
          'Il tuo ritorno ad alto valore è ancora possibile. E aperto un percorso più pulito.',
        timing: 'D14',
      ...
      b: {
        ...
        subject: 'Per il tuo account e disponibile una opzione di ritorno più leggera.',
        timing: 'D14',
        delay: '+7 giorni dopo esito non centrato',
      },
    },
  ...
  dormant_low_step2_email: {
    ...
    it: {
      ...
      b: {
        ...
        subject: 'Per il tuo account è ora disponibile un piano Bullwaves di recovery più leggero.',
        timing: 'D6',
        delay: '+6 giorni dopo step 1',
      },
    },
  ...
  dormant_mid_followup_retained_email: {
    ...
    it: {
      ...
      b: {
        ...
        subject: 'Buon risultato: il tuo account Bullwaves si è rimesso in movimento.',
        timing: 'CHECKPOINT +0d',
        delay: 'Follow-up immediato dopo esito positivo',
      },
    },
  ...
  dormant_mid_followup_recovery_email: {
    ...
    it: {
      a: {
        ...
        subject: 'Il tuo comeback Bullwaves è ancora possibile da un percorso più pulito.',
        timing: 'D18',
  ...
  dormant_mid_step2_email: {
    ...
    it: {
      ...
      b: {
        ...
        subject: 'Per il tuo account è ora attivo un piano Bullwaves di recovery più chiaro.',
        timing: 'D4',
        delay: '+4 giorni dopo step 1',
      },
    },
  ...
  dormant_value_step2_email: {
    ...
    it: {
      ...
      b: {
        ...
        subject:
          'Il tuo percorso di ritorno Bullwaves è ancora aperto ed ora e più facile da seguire.',
        timing: 'D3',
        delay: '+3 giorni dopo step 1',
      },
    },
  ...
  dormant_value_step1_email: {
    ...
    it: {
      ...
      b: {
        ...
        subject: 'E disponibile un modo più chiaro per ripartire con Bullwaves.',
        timing: 'D0',
        delay: "0 giorni dall'ingresso nel segmento",
      },
    },
  ...
  dormant_value_followup_recovery_email: {
    ...
    it: {
      a: {
        ...
        subject: 'Il tuo percorso di ritorno Bullwaves è ancora aperto.',
        timing: 'D18',
