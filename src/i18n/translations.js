...
export const translations = {
  en: {
    ...
    'executiveView.aria.showExplanation': 'Show explanation',
    'executiveView.loader.data': 'Loading data…',
    'executiveView.search.placeholder': 'Search…',

    'globalDashboard.loader.executiveSummary': 'Loading executive summary…',
    'globalDashboard.subtitle.panorama': 'Panorama',

    'mediaPayments.profitAnalysis.loader.mediaReport': 'Loading Media Report…',
    'mediaPayments.report.loader.data': 'Loading report data…',
    'mediaPayments.summary.loader.data': 'Loading data…',
    'profitAnalysis.loader.mediaReport': 'Loading Media Report…',

    // Execution Hub
    'execHub.share.cta': 'Share (public link)',
    'execHub.share.unavailable': 'Share link not available.',
    'execHub.share.copied': 'Link copied',
    'execHub.share.copyPrompt': 'Copy the link:',
    ...
    // Public share
    'publicShare.invalid': 'Invalid link',
    'publicShare.readOnlyGenerated': 'Read-only share link — generated {date}',
    'publicShare.execution.ogTitle': 'Execution Hub',
    'publicShare.execution.ogDescription':
      'Public read-only view of the Execution Hub (cockpit, stories, tasks).',
    'publicShare.execution.title': 'Execution Hub',
    ...
    'storiesKanban.lanes.done': 'Done',
    'storiesKanban.ownerLabel': 'Owner',

    // Epics
    'epics.Acquisition': 'Acquisition',
    'epics.Retention': 'Retention',
    'epics.Platform': 'Platform',
    'epics.Ops': 'Ops',

    // Story sidebar
    'storySidebar.ariaLabel': 'Story details',
    'storySidebar.openTasks': 'Open Tasks',
    'storySidebar.primaryKpi': 'Primary KPI',
    'storySidebar.kpiRow': 'KPI',
    'storySidebar.sections.goal': 'Goal',
    'storySidebar.sections.kpiTarget': 'KPI target',
    'storySidebar.sections.currentStatus': 'Current status',
    'storySidebar.sections.taskList': 'Task list',
    'storySidebar.sections.blockersAlerts': 'Blockers & alerts',
    'storySidebar.sections.decisionZone': 'Decision zone',
    'storySidebar.status.progress': 'Progress',
    'storySidebar.status.risk': 'Risk',
    'storySidebar.status.blockers': 'Blockers',
    'storySidebar.status.statusLabel': 'Status',
    'storySidebar.task.openCockpit': 'Open cockpit',
    'storySidebar.empty.noBlockers': 'No blockers',
    'storySidebar.empty.noDecisions': 'No decisions',

    // Task sidebar
    'taskSidebar.ariaLabel': 'Task details',
    'taskSidebar.header.kicker': 'Task',
    'taskSidebar.backToStory': 'Back to story',
    'taskSidebar.openTasks': 'Open Tasks',
    'taskSidebar.eta': 'ETA',
    'taskSidebar.sections.context': 'Context',
    'taskSidebar.sections.status': 'Status',
    'taskSidebar.status.progress': 'Progress',
    'taskSidebar.status.eta': 'ETA',
    'taskSidebar.dependencies': 'Dependencies',
    'taskSidebar.sections.subtasks': 'Subtasks',
    'taskSidebar.sections.links': 'Links',
    'taskSidebar.link': 'Link',
    'taskSidebar.sections.comments': 'Comments',
    'taskSidebar.readOnly': 'Read-only',
    'taskSidebar.writeComment': 'Write a comment…',
    'taskSidebar.send': 'Send',
    'taskSidebar.noComments': 'No comments yet',

    // Command Center
    'commandCenter.header.topline': 'Tools',
    'commandCenter.header.title': 'Command Center',
    'commandCenter.header.subtitle': 'Cockpit view: status, risks, decisions, execution.',
    'commandCenter.sections.systemStatus.title': 'Status',
    'commandCenter.sections.systemStatus.subtitle': 'Macro signals from the latest reports.',
    'commandCenter.updated': 'Updated:',
    'commandCenter.macro.acq.label': 'Acquisition',
    'commandCenter.macro.acq.secondary': 'Avg CPA: {cpa}',
    'commandCenter.macro.acq.hint': 'Quality signal: QFTD/FTD.',
    'commandCenter.macro.ret.label': 'Retention',
    'commandCenter.macro.ret.secondary': 'M3: {m3}',
    'commandCenter.macro.ret.hint': 'Cohort: {cohort}',
    'commandCenter.macro.reactivation.label': 'Reactivation',
    'commandCenter.macro.reactivation.secondary': 'M9: {m9}',
    'commandCenter.macro.reactivation.hint': 'Cohort: {cohort}',
    'commandCenter.macro.ops.label': 'Ops',
    'commandCenter.macro.ops.secondary': 'Withdrawals/Deposits: {ratio}',
    'commandCenter.macro.ops.hint': 'Cashflow health signal.',
    'commandCenter.sections.execution.title': 'Execution',
    'commandCenter.sections.execution.subtitle': 'Top stories by urgency and progress.',
    'commandCenter.executionBuckets.live': 'LIVE',
    'commandCenter.executionBuckets.next': 'NEXT',
    'commandCenter.executionBuckets.inProgress': 'IN PROGRESS',
    'commandCenter.story.progress': 'Progress {pct}%',
    'commandCenter.story.openTasks': 'Open tasks',
    'commandCenter.sections.timeline.title': 'Timeline',
    'commandCenter.sections.timeline.subtitle':
      'Real calendar week (Mon–Fri) with today highlighted.',
    'commandCenter.timeline.mon': 'Mon',
    'commandCenter.timeline.tue': 'Tue',
    'commandCenter.timeline.wed': 'Wed',
    'commandCenter.timeline.thu': 'Thu',
    'commandCenter.timeline.fri': 'Fri',
    'commandCenter.timeline.dayProgressLabel': 'Day progress',
    'commandCenter.sections.control.title': 'Control Tower',
    'commandCenter.sections.control.subtitle': 'Critical signals and actions required.',
    'commandCenter.control.criticalSignals': 'Critical signals',
    'commandCenter.control.actionsRequired': 'Actions required',
    'commandCenter.control.linked': 'Linked',
    'commandCenter.control.signals.netDepositsNegative': 'Net deposits negative: {value}',
    'commandCenter.control.signals.withdrawalExceeded': 'Withdrawals exceed deposits: {value}',
    'commandCenter.control.signals.withdrawalHigh': 'Withdrawals high vs deposits: {value}',
    'commandCenter.control.signals.qualifyLow': 'Qualified rate low: {value}',
    'commandCenter.control.signals.executionAtRisk': 'Execution at risk: {title}',

    // Tasks board
    'tasksBoard.header.title': 'Strategic Execution Control System',
    'tasksBoard.header.subtitle':
      'Bullwaves strategic initiatives board. Each card represents a strategic story with clear business impact.',
    'tasksBoard.actions.sharePublicLink': 'Share (public link)',
    'tasksBoard.actions.importAllStoryTasks': 'Import all story tasks',
    'tasksBoard.importAllStoryTasks.added': 'Imported {count} tasks from stories',
    'tasksBoard.importAllStoryTasks.none': 'All story tasks are already imported',
    'tasksBoard.importAllStoryTasks.failed': 'Failed to import story tasks',
    'tasksBoard.stats.total': 'Total: {count}',
    'tasksBoard.stats.filtered': '(filtered)',
    'tasksBoard.focus.title': 'Focused view',
    'tasksBoard.focus.titleWithStory': 'Focused on: {story}',
    'tasksBoard.focus.fallbackStory': 'Story',
    'tasksBoard.focus.label': 'Focus: {story}',
    'tasksBoard.empty.dropHere': 'Drop items here',
    'tasksBoard.share.notAvailable': 'Share link not available (share storage not configured).',
    'tasksBoard.share.copied': 'Link copied to clipboard',
    ...
    'tasksBoard.categories.platform': 'Platform',
    'tasksBoard.categories.partners': 'Partners',
    'tasksBoard.categories.ops': 'Ops',

    'tasksBoard.impact.high': 'High',
    'tasksBoard.impact.medium': 'Medium',
    'tasksBoard.impact.low': 'Low',
    ...
    'sidebar.marketingPlan': 'Marketing plan (stand by)',
    ...
    // Sales Agents Monitor
    'salesAgentsMonitor.section': 'Retention',
    'salesAgentsMonitor.title': 'Sales Agents Monitor',
    'salesAgentsMonitor.subtitle': 'Simple dashboard to monitor sales agents performance.',
    'salesAgentsMonitor.dataSource': 'Data source',
    'salesAgentsMonitor.filterByAgent': 'Filter by Agent',
    'salesAgentsMonitor.focusSalesTeamOnly': 'Focus only on current Sales team',
    'salesAgentsMonitor.searchAgents': 'Search agents...',
    'salesAgentsMonitor.kpi.agents': 'Agents',
    'salesAgentsMonitor.kpi.activeClients': 'Active Clients',
    'salesAgentsMonitor.kpi.totalDeposit': 'Total Deposit',
    'salesAgentsMonitor.kpi.totalNet': 'Total Net',
    'salesAgentsMonitor.kpi.avgNetPerAgent': 'Avg Net / Agent',
    'salesAgentsMonitor.timeframe.all': 'All Time',
    'salesAgentsMonitor.timeframe.last12': 'Last 12 Months',
    'salesAgentsMonitor.top6.title': 'Top 6 Best Agents',
    'salesAgentsMonitor.top6.subtitle': 'by Net Performance',
    'salesAgentsMonitor.top6.empty': 'No ranking data available.',
    'salesAgentsMonitor.charts.deposits.title': 'Deposits',
    'salesAgentsMonitor.charts.deposits.subtitle': 'Top performers by total deposits',
    'salesAgentsMonitor.charts.closedPl.title': 'Closed P&L',
    'salesAgentsMonitor.charts.closedPl.subtitle': 'Top performers by closed profit & loss',
    'salesAgentsMonitor.charts.empty': 'No data',
    'salesAgentsMonitor.table.rank': '#',
    'salesAgentsMonitor.table.agent': 'Agent',
    'salesAgentsMonitor.table.clients': 'Clients',
    'salesAgentsMonitor.table.active': 'Active',
    'salesAgentsMonitor.table.deposit': 'Deposit',
    'salesAgentsMonitor.table.wd': 'WD',
    'salesAgentsMonitor.table.net': 'Net',
    'salesAgentsMonitor.table.closedPl': 'Closed PL',
    'salesAgentsMonitor.table.trades': 'Trades',
    'salesAgentsMonitor.table.netPerClient': 'Net / Client',
    'salesAgentsMonitor.table.tradesPerClient': 'Trades / Client',
    'salesAgentsMonitor.table.momDelta': 'MoM Delta',
    'salesAgentsMonitor.table.noAgents': 'No agents available with current filters.',
    'salesAgentsMonitor.backToTop': 'Back to top',
    'salesAgentsMonitor.backToTopButton': '↑ Back to top',
    'salesAgentsMonitor.tooltip.rank': 'Position in ranking based on net value (descending).',
    'salesAgentsMonitor.tooltip.agent': 'Sales agent assigned to the client portfolio.',
    'salesAgentsMonitor.tooltip.clients': 'Total number of clients assigned to the agent.',
    'salesAgentsMonitor.tooltip.active': 'Clients with at least one trade in the selected period.',
    'salesAgentsMonitor.tooltip.deposit': 'Sum of all deposits from the agent clients.',
    'salesAgentsMonitor.tooltip.wd': 'Sum of all withdrawals from the agent clients.',
    'salesAgentsMonitor.tooltip.net': 'Net cash flow: deposits minus withdrawals.',
    'salesAgentsMonitor.tooltip.closedPl': 'Realized profit/loss from closed trades.',
    'salesAgentsMonitor.tooltip.trades': 'Total number of executed trades.',
    'salesAgentsMonitor.tooltip.netPerClient': 'Average net value per client.',
    'salesAgentsMonitor.tooltip.tradesPerClient': 'Average number of trades per client.',
    'salesAgentsMonitor.tooltip.momDelta': 'Difference between latest period net and previous period net.',
    'salesAgentsMonitor.personal.selectPlaceholder': 'Select one agent...',
    'salesAgentsMonitor.personal.title': 'Personal Dashboard — {name}',
    'salesAgentsMonitor.personal.subtitle': 'Focused performance view and actionable insights',
    'salesAgentsMonitor.personal.noData': 'No personal data available for the selected agent.',
    'salesAgentsMonitor.personal.kpi.clients': 'Clients',
    'salesAgentsMonitor.personal.kpi.activeRate': 'Active Rate',
    'salesAgentsMonitor.personal.kpi.net': 'Net',
    'salesAgentsMonitor.personal.kpi.netPerClient': 'Net / Client',
    'salesAgentsMonitor.personal.kpi.momDelta': 'MoM Delta',
    'salesAgentsMonitor.personal.insight.decline.title': 'Significant decline',
    'salesAgentsMonitor.personal.insight.decline.desc': 'Monthly net is down {pct}% vs previous period.',
    'salesAgentsMonitor.personal.insight.attrition.title': 'Client activity risk',
    'salesAgentsMonitor.personal.insight.attrition.desc': 'Only {pct}% of clients are currently active.',
    'salesAgentsMonitor.personal.insight.volume.title': 'High volume, low yield',
    'salesAgentsMonitor.personal.insight.volume.desc': 'Many trades but low net value per client.',
    'salesAgentsMonitor.personal.insight.negative.title': 'Negative financial signal',
    'salesAgentsMonitor.personal.insight.negative.desc': 'Net or closed P&L is below zero.',
    'salesAgentsMonitor.personal.insight.good.title': 'Healthy momentum',
    'salesAgentsMonitor.personal.insight.good.desc': 'No critical signals detected for this period.',
    'salesAgentsMonitor.personal.ctaTitle': 'Select an agent to open the personal dashboard',
    'salesAgentsMonitor.personal.ctaSubtitle': 'Use the agent selector above to switch from overview to individual insights.',
    'salesAgentsMonitor.alerts.title': 'Performance Alerts',
    'salesAgentsMonitor.alerts.subtitle': 'Agents requiring attention',
    'salesAgentsMonitor.alerts.empty': 'All agents performing well — no alerts.',
    'salesAgentsMonitor.alerts.decline.title': 'Significant Decline',
    'salesAgentsMonitor.alerts.decline.desc': 'Monthly net down {pct}% — review strategy',
    'salesAgentsMonitor.alerts.attrition.title': 'Client Attrition',
    'salesAgentsMonitor.alerts.attrition.desc': '{lost} clients became inactive',
    'salesAgentsMonitor.alerts.volume.title': 'High Volume, Low Yield',
    'salesAgentsMonitor.alerts.volume.desc': 'Many trades but below-median net per client',
    'salesAgentsMonitor.alerts.negative.title': 'Negative Performance',
    'salesAgentsMonitor.alerts.negative.desc': 'Net or Closed P&L below zero',

    // Platform Usage & Billing
    'platformUsageBilling.title': 'Platform Usage & Billing',
    'platformUsageBilling.subtitle':
      'Monitor provider usage and connect active accounts to the org chart.',
    'platformUsageBilling.subtitleBillingOnly':
      'Financial view: monthly invoices (no org chart mapping yet).',
    'platformUsageBilling.provider': 'Provider',
    'platformUsageBilling.period': 'Period',
    'platformUsageBilling.period.last7': 'Last 7 days',
    'platformUsageBilling.period.last15': 'Last 15 days',
    'platformUsageBilling.period.last30': 'Last 30 days',
    'platformUsageBilling.period.last60': 'Last 60 days',
    'platformUsageBilling.dataSource': 'Data source:',
    'platformUsageBilling.month': 'Month',
    'platformUsageBilling.invoiceForMonth': 'Invoice ({month})',
    'platformUsageBilling.dataNotAvailable': 'Data not available',
    'platformUsageBilling.usersNotAvailable': 'users.csv not available',
    'platformUsageBilling.usersSource': 'Users:',
    'platformUsageBilling.invoiceLink': 'Invoice PDF',
    'platformUsageBilling.invoice.month': 'Invoice month',
    'platformUsageBilling.invoice.total': 'Total payable',
    'platformUsageBilling.invoice.invoiceNo': 'Invoice',
    'platformUsageBilling.invoice.date': 'Invoice date',
    'platformUsageBilling.invoice.due': 'Due',
    'platformUsageBilling.invoice.vat': 'VAT',
    'platformUsageBilling.invoice.items': 'Line items',
    'platformUsageBilling.invoice.sku': 'SKU',
    'platformUsageBilling.invoice.qty': 'QTY',
    'platformUsageBilling.invoice.unitPrice': 'Unit price',
    'platformUsageBilling.invoice.amount': 'Amount',
    'platformUsageBilling.providerInactive': 'Provider not active yet.',
    'platformUsageBilling.providerInactiveHint':
      'Only Skale is currently connected. Select Skale to view usage and billing impact.',
    'platformUsageBilling.loading': 'Loading users…',

    'platformUsageBilling.kpi.totalUsers': 'Total Users',
    'platformUsageBilling.kpi.systemActive': 'Active CRM Users',
    'platformUsageBilling.kpi.active30': 'Users active in last {days} days',
    'platformUsageBilling.kpi.activeNoLogin30': 'Dormant Users (>{days} days no login)',

    'platformUsageBilling.orgImpact.eyebrow': 'Org Chart Impact',
    'platformUsageBilling.orgImpact.title': 'Org Chart Impact Table',
    'platformUsageBilling.orgImpact.orgNode': 'Department',
    'platformUsageBilling.orgImpact.teamLeader': 'Team Leader',
    'platformUsageBilling.orgImpact.total': 'Total Users',
    'platformUsageBilling.orgImpact.active30': 'Active in last {days} days',
    'platformUsageBilling.orgImpact.dormant': 'Dormant users (>{days} days)',
    'platformUsageBilling.orgImpact.action': 'Suggested Action',
    'platformUsageBilling.orgImpact.clickHint':
      'Click a department to expand details under the row.',
    'platformUsageBilling.orgImpact.openDepartment': 'Open department',

    'platformUsageBilling.departmentDetails.eyebrow': 'Department details',
    'platformUsageBilling.departmentDetails.title': 'Department',
    'platformUsageBilling.departmentDetails.noneSelected':
      'Select a department from the table above.',
    'platformUsageBilling.departmentDetails.clear': 'Clear',
    'platformUsageBilling.departmentDetails.active': 'Active Users',
    'platformUsageBilling.departmentDetails.notActive': 'Inactive Users',

    'platformUsageBilling.billing.eyebrow': 'Potential Billing Optimization',
    'platformUsageBilling.billing.title': 'Potential Billing Optimization',
    'platformUsageBilling.billing.dormantBillable': 'Dormant Users',
    'platformUsageBilling.billing.dormantBillableHint': 'Potentially billable dormant users',
    'platformUsageBilling.billing.monthly': 'Monthly impact',
    'platformUsageBilling.billing.quarterly': 'Quarterly impact',
    'platformUsageBilling.billing.yearly': 'Yearly impact',
    'platformUsageBilling.billing.rate': '$65 per user per month',
    'platformUsageBilling.billing.latestInvoice': 'Latest invoice',

    'platformUsageBilling.usersTable.eyebrow': 'Users',
    'platformUsageBilling.usersTable.title': 'Users table',
    'platformUsageBilling.usersTable.userName': 'User Name',
    'platformUsageBilling.usersTable.orgNode': 'Department',
    'platformUsageBilling.usersTable.role': 'Role',
    ...
    'creolabs.all': 'All',
    'creolabs.range': 'Range',
    'creolabs.range.custom': 'Custom',
    'creolabs.range.start': 'Start period',
    'creolabs.range.end': 'End period',
    'creolabs.rows': 'Rows',
    'creolabs.rowsSummary': 'Rows: {shown} of {total}',
    'creolabs.periods': 'Periods',
    'creolabs.search.placeholder': 'Search client…',
    'creolabs.search.ariaLabel': 'Search client',
    'creolabs.empty': 'No results for this period.',
    'creolabs.errorTitle': 'Unable to load Creolabs',
    ...
    'shareAffiliateReports.chart.legend.pl': 'P&L (monthly)',
    ...
    'shareAffiliateReports.chart.tooltip.pl': 'P&L',
    ...
    'upload.response.openLog': 'Open log',
    'upload.emptyDash': '—',
    ...
    'upload.result.ok': 'OK',
    'upload.result.failed': 'Failed',
    'upload.result.type': 'Type',
    'upload.result.updated': 'Updated',
    'upload.result.rawBackup': 'Raw backup',
    'upload.result.logFile': 'Log file',
    'upload.result.sanitizer': 'Sanitizer',
    'upload.result.converted': 'Converted',
    'upload.result.yes': 'Yes',
    'upload.result.no': 'No',
    'upload.result.convertedFrom': 'Converted from',
    'upload.result.convertedSheet': 'Sheet',
    'upload.result.summary': 'Summary',
    'upload.result.summary.existing': 'Existing',
    'upload.result.summary.added': 'Added',
    'upload.result.summary.updated': 'Updated',
    ...
    'upload.result.postProcessing': 'Post-processing',
    'upload.result.status': 'Status',
    'upload.result.postProcessingDetails': 'Details',
    'upload.result.logsSaved': 'Full logs saved to file.',
    'upload.result.verboseMode': 'Tip: add ?verbose=1 for detailed logs.',
    'upload.result.logs': 'Logs',
    'upload.result.lastLogs': 'Last logs',
    'upload.result.warningsErrors': 'Warnings/Errors',
    'upload.result.rawJson': 'Raw JSON',
    ...
    'support.details.partnerProfile.label': 'Cellxpert',
    'support.details.partnerProfile.hint': 'Open in Cellxpert ({customerId})',
    'support.details.skale.label': 'Skale',
    'support.details.skale.hint': 'Open in Skale ({recordId})',
    ...
    'support.details.country': 'Country',
  ...
  it: {
    ...
    'common.owner': 'Owner',
    'common.due': 'Scadenza',
    'common.progressPct': 'Avanzamento: {pct}%',
    'common.markDone': 'Segna come fatto',
    'common.markNotDone': 'Segna come non fatto',
    'common.obscured': 'Oscurato',
    ...
    'executiveView.aria.showExplanation': 'Mostra spiegazione',
    'executiveView.loader.data': 'Caricamento dati…',
    'executiveView.search.placeholder': 'Cerca…',

    'globalDashboard.loader.executiveSummary': 'Caricamento sintesi esecutiva…',
    'globalDashboard.subtitle.panorama': 'Panoramica',

    'mediaPayments.profitAnalysis.loader.mediaReport': 'Caricamento Media Report…',
    'mediaPayments.report.loader.data': 'Caricamento dati report…',
    'mediaPayments.summary.loader.data': 'Caricamento dati…',
    'profitAnalysis.loader.mediaReport': 'Caricamento Media Report…',

    // Execution Hub
    'execHub.share.cta': 'Condividi (link pubblico)',
    'execHub.share.unavailable': 'Share link non disponibile.',
    'execHub.share.copied': 'Link copiato',
    'execHub.share.copyPrompt': 'Copia il link:',
    ...
    // Public share
    'publicShare.invalid': 'Link non valido',
    'publicShare.readOnlyGenerated': 'Link condiviso (sola lettura) — generato {date}',
    'publicShare.execution.ogTitle': 'Execution Hub',
    'publicShare.execution.ogDescription':
      'Vista pubblica in sola lettura dell’Execution Hub (cockpit, stories, tasks).',
    'publicShare.execution.title': 'Execution Hub',
    'publicShare.tasks.ogTitle': 'Tasks',
    ...
    'storiesKanban.lanes.done': 'Fatte',
    'storiesKanban.ownerLabel': 'Owner',
    ...
    // Story sidebar
    'storySidebar.ariaLabel': 'Dettagli storia',
    'storySidebar.openTasks': 'Apri Tasks',
    'storySidebar.primaryKpi': 'KPI primario',
    'storySidebar.kpiRow': 'KPI',
    'storySidebar.sections.goal': 'Obiettivo',
    'storySidebar.sections.kpiTarget': 'KPI target',
    'storySidebar.sections.currentStatus': 'Stato attuale',
    'storySidebar.sections.taskList': 'Lista task',
    'storySidebar.sections.blockersAlerts': 'Blocchi & alert',
    'storySidebar.sections.decisionZone': 'Zona decisioni',
    'storySidebar.status.progress': 'Avanzamento',
    'storySidebar.status.risk': 'Rischio',
    'storySidebar.status.blockers': 'Blocchi',
    'storySidebar.status.statusLabel': 'Stato',
    'storySidebar.task.openCockpit': 'Apri cockpit',
    'storySidebar.empty.noBlockers': 'Nessun blocco',
    'storySidebar.empty.noDecisions': 'Nessuna decisione',

    // Task sidebar
    'taskSidebar.ariaLabel': 'Dettagli task',
    'taskSidebar.header.kicker': 'Task',
    'taskSidebar.backToStory': 'Torna alla storia',
    'taskSidebar.openTasks': 'Apri Tasks',
    'taskSidebar.eta': 'ETA',
    'taskSidebar.sections.context': 'Contesto',
    'taskSidebar.sections.status': 'Stato',
    'taskSidebar.status.progress': 'Avanzamento',
    'taskSidebar.status.eta': 'ETA',
    'taskSidebar.dependencies': 'Dipendenze',
    'taskSidebar.sections.subtasks': 'Sotto-task',
    'taskSidebar.sections.links': 'Link',
    'taskSidebar.link': 'Link',
    'taskSidebar.sections.comments': 'Commenti',
    'taskSidebar.readOnly': 'Sola lettura',
    'taskSidebar.writeComment': 'Scrivi un commento…',
    'taskSidebar.send': 'Invia',
    'taskSidebar.noComments': 'Ancora nessun commento',

    // Command Center
    'commandCenter.header.topline': 'Strumenti',
    'commandCenter.header.title': 'Command Center',
    'commandCenter.header.subtitle': 'Vista cockpit: stato, rischi, decisioni, esecuzione.',
    'commandCenter.sections.systemStatus.title': 'Stato',
    'commandCenter.sections.systemStatus.subtitle': 'Segnali macro dagli ultimi report.',
    'commandCenter.updated': 'Aggiornato:',
    'commandCenter.macro.acq.label': 'Acquisizione',
    'commandCenter.macro.acq.secondary': 'CPA medio: {cpa}',
    'commandCenter.macro.acq.hint': 'Segnale qualità: QFTD/FTD.',
    'commandCenter.macro.ret.label': 'Retention',
    'commandCenter.macro.ret.secondary': 'M3: {m3}',
    'commandCenter.macro.ret.hint': 'Cohort: {cohort}',
    'commandCenter.macro.reactivation.label': 'Riattivazione',
    'commandCenter.macro.reactivation.secondary': 'M9: {m9}',
    'commandCenter.macro.reactivation.hint': 'Cohort: {cohort}',
    'commandCenter.macro.ops.label': 'Ops',
    'commandCenter.macro.ops.secondary': 'Prelievi/Depositi: {ratio}',
    'commandCenter.macro.ops.hint': 'Segnale salute cashflow.',
    'commandCenter.sections.execution.title': 'Esecuzione',
    'commandCenter.sections.execution.subtitle': 'Top stories per urgenza e avanzamento.',
    'commandCenter.executionBuckets.live': 'LIVE',
    'commandCenter.executionBuckets.next': 'NEXT',
    'commandCenter.executionBuckets.inProgress': 'IN CORSO',
    'commandCenter.story.progress': 'Avanzamento {pct}%',
    'commandCenter.story.openTasks': 'Apri task',
    'commandCenter.sections.timeline.title': 'Timeline',
    'commandCenter.sections.timeline.subtitle':
      'Settimana reale (Lun–Ven) con evidenza sulla giornata in corso.',
    'commandCenter.timeline.mon': 'Lun',
    'commandCenter.timeline.tue': 'Mar',
    'commandCenter.timeline.wed': 'Mer',
    'commandCenter.timeline.thu': 'Gio',
    'commandCenter.timeline.fri': 'Ven',
    'commandCenter.timeline.dayProgressLabel': 'Progresso giornata',
    'commandCenter.sections.control.title': 'Control Tower',
    'commandCenter.sections.control.subtitle': 'Segnali critici e azioni richieste.',
    'commandCenter.control.criticalSignals': 'Segnali critici',
    'commandCenter.control.actionsRequired': 'Azioni richieste',
    'commandCenter.control.linked': 'Collegato',
    'commandCenter.control.signals.netDepositsNegative': 'Depositi netti negativi: {value}',
    'commandCenter.control.signals.withdrawalExceeded': 'Prelievi sopra i depositi: {value}',
    'commandCenter.control.signals.withdrawalHigh': 'Prelievi alti vs depositi: {value}',
    'commandCenter.control.signals.qualifyLow': 'Tasso qualificati basso: {value}',
    'commandCenter.control.signals.executionAtRisk': 'Esecuzione a rischio: {title}',

    // Tasks board
    'tasksBoard.header.title': 'Sistema di Controllo Esecuzione Strategica',
    'tasksBoard.header.subtitle':
      'Board delle iniziative strategiche Bullwaves. Ogni card rappresenta una storia strategica con impatto business chiaro.',
    'tasksBoard.actions.sharePublicLink': 'Condividi (link pubblico)',
    'tasksBoard.actions.importAllStoryTasks': 'Importa tutti i task delle stories',
    'tasksBoard.importAllStoryTasks.added': 'Importati {count} task dalle stories',
    'tasksBoard.importAllStoryTasks.none': 'Tutti i task delle stories sono già importati',
    'tasksBoard.importAllStoryTasks.failed': 'Import dei task dalle stories non riuscito',
    'tasksBoard.stats.total': 'Totale: {count}',
    'tasksBoard.stats.filtered': '(filtrato)',
    'tasksBoard.focus.title': 'Vista in focus',
    'tasksBoard.focus.titleWithStory': 'In focus su: {story}',
    'tasksBoard.focus.fallbackStory': 'Storia',
    'tasksBoard.focus.label': 'Focus: {story}',
    'tasksBoard.empty.dropHere': 'Trascina qui gli elementi',
    'tasksBoard.share.notAvailable': 'Share link non disponibile (storage share non configurato).',
    'tasksBoard.share.copied': 'Link copiato negli appunti',
    ...
    'tasksBoard.categories.retention': 'Retention',
    'tasksBoard.categories.platform': 'Platform',
    'tasksBoard.categories.partners': 'Partner',
    'tasksBoard.categories.ops': 'Ops',

    'tasksBoard.impact.high': 'Alto',
    'tasksBoard.impact.medium': 'Medio',
    'tasksBoard.impact.low': 'Basso',
    ...
    // Sales Agents Monitor
    'salesAgentsMonitor.section': 'Retention',
    'salesAgentsMonitor.title': 'Monitor Sales Agents',
    'salesAgentsMonitor.subtitle': 'Dashboard semplice per monitorare le performance degli agenti sales.',
    'salesAgentsMonitor.dataSource': 'Fonte dati',
    'salesAgentsMonitor.filterByAgent': 'Filtra per agente',
    'salesAgentsMonitor.focusSalesTeamOnly': 'Focus solo sul team Sales attuale',
    'salesAgentsMonitor.searchAgents': 'Cerca agenti...',
    'salesAgentsMonitor.kpi.agents': 'Agenti',
    'salesAgentsMonitor.kpi.activeClients': 'Clienti attivi',
    'salesAgentsMonitor.kpi.totalDeposit': 'Deposito totale',
    'salesAgentsMonitor.kpi.totalNet': 'Net totale',
    'salesAgentsMonitor.kpi.avgNetPerAgent': 'Net medio / Agente',
    'salesAgentsMonitor.timeframe.all': 'Sempre',
    'salesAgentsMonitor.timeframe.last12': 'Ultimi 12 mesi',
    'salesAgentsMonitor.top6.title': 'Top 6 Migliori Agenti',
    'salesAgentsMonitor.top6.subtitle': 'per performance Net',
    'salesAgentsMonitor.top6.empty': 'Nessun dato ranking disponibile.',
    'salesAgentsMonitor.charts.deposits.title': 'Depositi',
    'salesAgentsMonitor.charts.deposits.subtitle': 'Top performer per depositi totali',
    'salesAgentsMonitor.charts.closedPl.title': 'Closed P&L',
    'salesAgentsMonitor.charts.closedPl.subtitle': 'Top performer per profit/loss chiuso',
    'salesAgentsMonitor.charts.empty': 'Nessun dato',
    'salesAgentsMonitor.table.rank': '#',
    'salesAgentsMonitor.table.agent': 'Agente',
    'salesAgentsMonitor.table.clients': 'Clienti',
    'salesAgentsMonitor.table.active': 'Attivi',
    'salesAgentsMonitor.table.deposit': 'Deposito',
    'salesAgentsMonitor.table.wd': 'Prelievi',
    'salesAgentsMonitor.table.net': 'Net',
    'salesAgentsMonitor.table.closedPl': 'Closed PL',
    'salesAgentsMonitor.table.trades': 'Trades',
    'salesAgentsMonitor.table.netPerClient': 'Net / Cliente',
    'salesAgentsMonitor.table.tradesPerClient': 'Trades / Cliente',
    'salesAgentsMonitor.table.momDelta': 'Delta MoM',
    'salesAgentsMonitor.table.noAgents': 'Nessun agente disponibile con i filtri correnti.',
    'salesAgentsMonitor.backToTop': 'Torna su',
    'salesAgentsMonitor.backToTopButton': '↑ Torna su',
    'salesAgentsMonitor.tooltip.rank': 'Posizione nel ranking in base al valore net (decrescente).',
    'salesAgentsMonitor.tooltip.agent': 'Agente sales assegnato al portafoglio clienti.',
    'salesAgentsMonitor.tooltip.clients': 'Numero totale di clienti assegnati all\'agente.',
    'salesAgentsMonitor.tooltip.active': 'Clienti con almeno un trade nel periodo selezionato.',
    'salesAgentsMonitor.tooltip.deposit': 'Somma di tutti i depositi dei clienti dell\'agente.',
    'salesAgentsMonitor.tooltip.wd': 'Somma di tutti i prelievi dei clienti dell\'agente.',
    'salesAgentsMonitor.tooltip.net': 'Flusso di cassa netto: depositi meno prelievi.',
    'salesAgentsMonitor.tooltip.closedPl': 'Profit/Loss realizzato su operazioni chiuse.',
    'salesAgentsMonitor.tooltip.trades': 'Numero totale di operazioni eseguite.',
    'salesAgentsMonitor.tooltip.netPerClient': 'Valore netto medio per cliente.',
    'salesAgentsMonitor.tooltip.tradesPerClient': 'Numero medio di operazioni per cliente.',
    'salesAgentsMonitor.tooltip.momDelta': 'Differenza tra net dell\'ultimo periodo e net del periodo precedente.',
    'salesAgentsMonitor.personal.selectPlaceholder': 'Seleziona un agente...',
    'salesAgentsMonitor.personal.title': 'Dashboard personale — {name}',
    'salesAgentsMonitor.personal.subtitle': 'Vista focalizzata con insight operativi',
    'salesAgentsMonitor.personal.noData': 'Nessun dato personale disponibile per l\'agente selezionato.',
    'salesAgentsMonitor.personal.kpi.clients': 'Clienti',
    'salesAgentsMonitor.personal.kpi.activeRate': 'Tasso attivi',
    'salesAgentsMonitor.personal.kpi.net': 'Net',
    'salesAgentsMonitor.personal.kpi.netPerClient': 'Net / Cliente',
    'salesAgentsMonitor.personal.kpi.momDelta': 'Delta MoM',
    'salesAgentsMonitor.personal.insight.decline.title': 'Calo significativo',
    'salesAgentsMonitor.personal.insight.decline.desc': 'Il net mensile e in calo del {pct}% rispetto al periodo precedente.',
    'salesAgentsMonitor.personal.insight.attrition.title': 'Rischio attivita clienti',
    'salesAgentsMonitor.personal.insight.attrition.desc': 'Solo il {pct}% dei clienti risulta attivo.',
    'salesAgentsMonitor.personal.insight.volume.title': 'Alto volume, basso rendimento',
    'salesAgentsMonitor.personal.insight.volume.desc': 'Molti trade ma valore netto per cliente basso.',
    'salesAgentsMonitor.personal.insight.negative.title': 'Segnale finanziario negativo',
    'salesAgentsMonitor.personal.insight.negative.desc': 'Net o Closed P&L sotto zero.',
    'salesAgentsMonitor.personal.insight.good.title': 'Momentum positivo',
    'salesAgentsMonitor.personal.insight.good.desc': 'Nessun segnale critico rilevato nel periodo.',
    'salesAgentsMonitor.personal.ctaTitle': 'Seleziona un agente per aprire la dashboard personale',
    'salesAgentsMonitor.personal.ctaSubtitle': 'Usa il selettore agente in alto per passare dalla overview agli insight individuali.',
    'salesAgentsMonitor.alerts.title': 'Alert Performance',
    'salesAgentsMonitor.alerts.subtitle': 'Agenti che richiedono attenzione',
    'salesAgentsMonitor.alerts.empty': 'Tutti gli agenti performano bene — nessun alert.',
    'salesAgentsMonitor.alerts.decline.title': 'Calo significativo',
    'salesAgentsMonitor.alerts.decline.desc': 'Net mensile giù del {pct}% — revisionare strategia',
    'salesAgentsMonitor.alerts.attrition.title': 'Perdita clienti',
    'salesAgentsMonitor.alerts.attrition.desc': '{lost} clienti diventati inattivi',
    'salesAgentsMonitor.alerts.volume.title': 'Alto volume, basso rendimento',
    'salesAgentsMonitor.alerts.volume.desc': 'Molte operazioni ma net per cliente sotto media',
    'salesAgentsMonitor.alerts.negative.title': 'Performance negativa',
    'salesAgentsMonitor.alerts.negative.desc': 'Net o Closed P&L sotto zero',

    // Platform Usage & Billing
    'platformUsageBilling.title': 'Platform Usage & Billing',
    'platformUsageBilling.subtitle':
      "Monitora l'utilizzo del provider e collega gli account attivi all'org chart.",
    'platformUsageBilling.subtitleBillingOnly':
      'Vista finanziaria: fatture mensili (nessun collegamento org chart al momento).',
    'platformUsageBilling.provider': 'Provider',
    'platformUsageBilling.period': 'Periodo',
    'platformUsageBilling.period.last7': 'Ultimi 7 giorni',
    'platformUsageBilling.period.last15': 'Ultimi 15 giorni',
    'platformUsageBilling.period.last30': 'Ultimi 30 giorni',
    'platformUsageBilling.period.last60': 'Ultimi 60 giorni',
    'platformUsageBilling.dataSource': 'Fonte dati:',
    'platformUsageBilling.month': 'Mese',
    'platformUsageBilling.invoiceForMonth': 'Fattura ({month})',
    'platformUsageBilling.dataNotAvailable': 'Dati non disponibili',
    'platformUsageBilling.usersNotAvailable': 'users.csv non disponibile',
    'platformUsageBilling.usersSource': 'Utenti:',
    'platformUsageBilling.invoiceLink': 'Fattura PDF',
    'platformUsageBilling.invoice.month': 'Mese fattura',
    'platformUsageBilling.invoice.total': 'Totale da pagare',
    'platformUsageBilling.invoice.invoiceNo': 'Fattura',
    'platformUsageBilling.invoice.date': 'Data fattura',
    'platformUsageBilling.invoice.due': 'Scadenza',
    'platformUsageBilling.invoice.vat': 'IVA',
    'platformUsageBilling.invoice.items': 'Voci',
    'platformUsageBilling.invoice.sku': 'SKU',
    'platformUsageBilling.invoice.qty': 'QTY',
    'platformUsageBilling.invoice.unitPrice': 'Prezzo unitario',
    'platformUsageBilling.invoice.amount': 'Totale',
    'platformUsageBilling.providerInactive': 'Provider non ancora attivo.',
    'platformUsageBilling.providerInactiveHint':
      'Al momento è connesso solo Skale. Seleziona Skale per vedere utilizzo e impatto billing.',
    'platformUsageBilling.loading': 'Caricamento utenti…',

    'platformUsageBilling.kpi.totalUsers': 'Utenti totali',
    'platformUsageBilling.kpi.systemActive': 'Utenti CRM attivi',
    'platformUsageBilling.kpi.active30': 'Utenti attivi negli ultimi {days} giorni',
    'platformUsageBilling.kpi.activeNoLogin30': 'Utenti dormienti (>{days} giorni senza login)',

    'platformUsageBilling.orgImpact.eyebrow': 'Impatto Org Chart',
    'platformUsageBilling.orgImpact.title': 'Tabella impatto Org Chart',
    'platformUsageBilling.orgImpact.orgNode': 'Dipartimento',
    'platformUsageBilling.orgImpact.teamLeader': 'Team leader',
    'platformUsageBilling.orgImpact.total': 'Utenti totali',
    'platformUsageBilling.orgImpact.active30': 'Attivi ultimi {days} giorni',
    'platformUsageBilling.orgImpact.dormant': 'Dormienti (>{days} giorni)',
    'platformUsageBilling.orgImpact.action': 'Azione suggerita',
    'platformUsageBilling.orgImpact.clickHint':
      'Clicca un dipartimento per espandere i dettagli sotto la riga.',
    'platformUsageBilling.orgImpact.openDepartment': 'Apri dipartimento',

    'platformUsageBilling.departmentDetails.eyebrow': 'Dettaglio dipartimento',
    'platformUsageBilling.departmentDetails.title': 'Dipartimento',
    'platformUsageBilling.departmentDetails.noneSelected':
      'Seleziona un dipartimento dalla tabella sopra.',
    'platformUsageBilling.departmentDetails.clear': 'Pulisci',
    'platformUsageBilling.departmentDetails.active': 'Utenti attivi',
    'platformUsageBilling.departmentDetails.notActive': 'Utenti non attivi',

    'platformUsageBilling.billing.eyebrow': 'Ottimizzazione potenziale billing',
    'platformUsageBilling.billing.title': 'Ottimizzazione potenziale billing',
    'platformUsageBilling.billing.dormantBillable': 'Utenti dormienti',
    'platformUsageBilling.billing.dormantBillableHint':
      'Utenti dormienti potenzialmente fatturabili',
    'platformUsageBilling.billing.monthly': 'Impatto mensile',
    'platformUsageBilling.billing.quarterly': 'Impatto trimestrale',
    'platformUsageBilling.billing.yearly': 'Impatto annuale',
    'platformUsageBilling.billing.rate': '$65 per utente al mese',
    'platformUsageBilling.billing.latestInvoice': 'Ultima fattura',

    'platformUsageBilling.usersTable.eyebrow': 'Utenti',
    'platformUsageBilling.usersTable.title': 'Tabella utenti',
    'platformUsageBilling.usersTable.userName': 'Nome utente',
    'platformUsageBilling.usersTable.orgNode': 'Dipartimento',
    'platformUsageBilling.usersTable.role': 'Ruolo',
    ...
    'creolabs.month': 'Mese',
    'creolabs.all': 'Tutti',
    'creolabs.range': 'Intervallo',
    'creolabs.range.custom': 'Custom',
    'creolabs.range.start': 'Periodo iniziale',
    'creolabs.range.end': 'Periodo finale',
    'creolabs.rows': 'Righe',
    'creolabs.rowsSummary': 'Righe: {shown} su {total}',
    'creolabs.periods': 'Periodi',
    'creolabs.search.placeholder': 'Cerca cliente…',
    'creolabs.search.ariaLabel': 'Cerca cliente',
    'creolabs.empty': 'Nessun risultato per questo periodo.',
    'creolabs.errorTitle': 'Impossibile caricare Creolabs',
    ...
    'shareAffiliateReports.chart.tooltip.ftd': 'FTD',
    'shareAffiliateReports.chart.legend.pl': 'P&L (mensile)',
    'shareAffiliateReports.chart.tooltip.qftd': 'QFTD',
    ...
    'upload.response.openLog': 'Apri log',
    'upload.emptyDash': '—',
    ...
    'upload.result.ok': 'OK',
    'upload.result.failed': 'Fallito',
    'upload.result.type': 'Tipo',
    'upload.result.updated': 'Aggiornato',
    'upload.result.rawBackup': 'Backup raw',
    'upload.result.logFile': 'File log',
    'upload.result.sanitizer': 'Sanitizer',
    'upload.result.converted': 'Convertito',
    'upload.result.yes': 'Sì',
    'upload.result.no': 'No',
    'upload.result.convertedFrom': 'Convertito da',
    'upload.result.convertedSheet': 'Foglio',
    'upload.result.summary': 'Riepilogo',
    'upload.result.summary.existing': 'Esistenti',
    'upload.result.summary.added': 'Aggiunte',
    'upload.result.summary.updated': 'Aggiornate',
    ...
    'upload.result.postProcessing': 'Post-processing',
    'upload.result.status': 'Stato',
    'upload.result.postProcessingDetails': 'Dettagli',
    'upload.result.logsSaved': 'Log completi salvati su file.',
    'upload.result.verboseMode': 'Suggerimento: aggiungi ?verbose=1 per log dettagliati.',
    'upload.result.logs': 'Log',
    'upload.result.lastLogs': 'Ultimi log',
    'upload.result.warningsErrors': 'Warning/Errori',
    'upload.result.rawJson': 'JSON raw',
    ...
    'support.details.partnerProfile.label': 'Cellxpert',
    'support.details.partnerProfile.hint': 'Apri su Cellxpert ({customerId})',
    'support.details.skale.label': 'Skale',
    'support.details.skale.hint': 'Apri su Skale ({recordId})',
  ...
  sr: {
    ...
    // Common
    'common.readOnly': 'Samo za čitanje',
    'common.clear': 'Očisti',
    'common.owner': 'Vlasnik',
    'common.due': 'Rok',
    'common.progressPct': 'Napredak: {pct}%',
    'common.markDone': 'Označi kao završeno',
    'common.markNotDone': 'Označi kao nije završeno',
    'common.obscured': 'Sakriveno',
    'common.accessDenied': 'Pristup odbijen',
    'common.error': 'Greška',
    'common.copied': 'Kopirano',
    'common.copyLink': 'Kopiraj link',
    'common.view': 'Prikaži',

    'executiveView.aria.showExplanation': 'Prikaži objašnjenje',
    'executiveView.loader.data': 'Učitavanje podataka…',
    'executiveView.search.placeholder': 'Pretraga…',

    'globalDashboard.loader.executiveSummary': 'Učitavanje izvršnog sažetka…',
    'globalDashboard.subtitle.panorama': 'Panorama',

    'mediaPayments.profitAnalysis.loader.mediaReport': 'Učitavanje Media Report-a…',
    'mediaPayments.report.loader.data': 'Učitavanje podataka izveštaja…',
    'mediaPayments.summary.loader.data': 'Učitavanje podataka…',
    'profitAnalysis.loader.mediaReport': 'Učitavanje Media Report-a…',

    // Execution Hub
    'execHub.share.cta': 'Podeli (javni link)',
    'execHub.share.unavailable': 'Share link nije dostupan.',
    'execHub.share.copied': 'Link je kopiran',
    'execHub.share.copyPrompt': 'Kopiraj link:',
    ...
    // Public share
    'publicShare.invalid': 'Nevažeći link',
    'publicShare.readOnlyGenerated': 'Share link (samo čitanje) — generisano {date}',
    'publicShare.execution.ogTitle': 'Execution Hub',
    'publicShare.execution.ogDescription':
      'Javni prikaz (samo čitanje) Execution Hub-a (cockpit, stories, tasks).',
    'publicShare.execution.title': 'Execution Hub',
    'publicShare.tasks.ogTitle': 'Tasks',
    ...
    'storiesKanban.lanes.done': 'Završeno',
    'storiesKanban.ownerLabel': 'Vlasnik',

    // Epics
    'epics.Acquisition': 'Akvizicija',
    'epics.Retention': 'Retencija',
    'epics.Platform': 'Platforma',
    'epics.Ops': 'Operacije',

    // Story sidebar
    'storySidebar.ariaLabel': 'Detalji priče',
    'storySidebar.openTasks': 'Otvori Tasks',
    'storySidebar.primaryKpi': 'Primarni KPI',
    'storySidebar.kpiRow': 'KPI',
    'storySidebar.sections.goal': 'Cilj',
    'storySidebar.sections.kpiTarget': 'KPI cilj',
    'storySidebar.sections.currentStatus': 'Trenutni status',
    'storySidebar.sections.taskList': 'Lista taskova',
    'storySidebar.sections.blockersAlerts': 'Blokade i upozorenja',
    'storySidebar.sections.decisionZone': 'Zona odluka',
    'storySidebar.status.progress': 'Napredak',
    'storySidebar.status.risk': 'Rizik',
    'storySidebar.status.blockers': 'Blokade',
    'storySidebar.status.statusLabel': 'Status',
    'storySidebar.task.openCockpit': 'Otvori cockpit',
    'storySidebar.empty.noBlockers': 'Nema blokada',
    'storySidebar.empty.noDecisions': 'Nema odluka',

    // Task sidebar
    'taskSidebar.ariaLabel': 'Detalji taska',
    'taskSidebar.header.kicker': 'Task',
    'taskSidebar.backToStory': 'Nazad na priču',
    'taskSidebar.openTasks': 'Otvori Tasks',
    'taskSidebar.eta': 'ETA',
    'taskSidebar.sections.context': 'Kontekst',
    'taskSidebar.sections.status': 'Status',
    'taskSidebar.status.progress': 'Napredak',
    'taskSidebar.status.eta': 'ETA',
    'taskSidebar.dependencies': 'Zavisnosti',
    'taskSidebar.sections.subtasks': 'Podzadaci',
    'taskSidebar.sections.links': 'Linkovi',
    'taskSidebar.link': 'Link',
    'taskSidebar.sections.comments': 'Komentari',
    'taskSidebar.readOnly': 'Samo za čitanje',
    'taskSidebar.writeComment': 'Napiši komentar…',
    'taskSidebar.send': 'Pošalji',
    'taskSidebar.noComments': 'Još nema komentara',

    // Command Center
    'commandCenter.header.topline': 'Alati',
    'commandCenter.header.title': 'Command Center',
    'commandCenter.header.subtitle': 'Cockpit prikaz: status, rizici, odluke, izvršenje.',
    'commandCenter.sections.systemStatus.title': 'Status',
    'commandCenter.sections.systemStatus.subtitle': 'Makro signali iz poslednjih izveštaja.',
    'commandCenter.updated': 'Ažurirano:',
    'commandCenter.macro.acq.label': 'Akvizicija',
    'commandCenter.macro.acq.secondary': 'Prosečan CPA: {cpa}',
    'commandCenter.macro.acq.hint': 'Signal kvaliteta: QFTD/FTD.',
    'commandCenter.macro.ret.label': 'Retencija',
    'commandCenter.macro.ret.secondary': 'M3: {m3}',
    'commandCenter.macro.ret.hint': 'Kohorta: {cohort}',
    'commandCenter.macro.reactivation.label': 'Reaktivacija',
    'commandCenter.macro.reactivation.secondary': 'M9: {m9}',
    'commandCenter.macro.reactivation.hint': 'Kohorta: {cohort}',
    'commandCenter.macro.ops.label': 'Operacije',
    'commandCenter.macro.ops.secondary': 'Isplate/Uplate: {ratio}',
    'commandCenter.macro.ops.hint': 'Signal zdravlja cashflow-a.',
    'commandCenter.sections.execution.title': 'Izvršenje',
    'commandCenter.sections.execution.subtitle': 'Top priče po hitnosti i napretku.',
    'commandCenter.executionBuckets.live': 'LIVE',
    'commandCenter.executionBuckets.next': 'NEXT',
    'commandCenter.executionBuckets.inProgress': 'U TOKU',
    'commandCenter.story.progress': 'Napredak {pct}%',
    'commandCenter.story.openTasks': 'Otvori taskove',
    'commandCenter.sections.timeline.title': 'Timeline',
    'commandCenter.sections.timeline.subtitle':
      'Stvarna nedelja (Pon–Pet) sa istaknutim današnjim danom.',
    'commandCenter.timeline.mon': 'Pon',
    'commandCenter.timeline.tue': 'Uto',
    'commandCenter.timeline.wed': 'Sre',
    'commandCenter.timeline.thu': 'Čet',
    'commandCenter.timeline.fri': 'Pet',
    'commandCenter.timeline.dayProgressLabel': 'Napredak dana',
    'commandCenter.sections.control.title': 'Control Tower',
    'commandCenter.sections.control.subtitle': 'Kritični signali i potrebne akcije.',
    'commandCenter.control.criticalSignals': 'Kritični signali',
    'commandCenter.control.actionsRequired': 'Potrebne akcije',
    'commandCenter.control.linked': 'Povezano',
    'commandCenter.control.signals.netDepositsNegative': 'Neto depoziti negativni: {value}',
    'commandCenter.control.signals.withdrawalExceeded': 'Isplate veće od uplata: {value}',
    'commandCenter.control.signals.withdrawalHigh': 'Isplate visoke u odnosu na uplate: {value}',
    'commandCenter.control.signals.qualifyLow': 'Nizak kvalifikovani odnos: {value}',
    'commandCenter.control.signals.executionAtRisk': 'Izvršenje rizično: {title}',

    // Tasks board
    'tasksBoard.header.title': 'Strategic Execution Control System',
    'tasksBoard.header.subtitle':
      'Bullwaves tabla strateških inicijativa. Svaka kartica predstavlja stratešku priču sa jasnim poslovnim uticajem.',
    'tasksBoard.actions.sharePublicLink': 'Podeli (javni link)',
    'tasksBoard.actions.importAllStoryTasks': 'Uvezi sve taskove iz priča',
    'tasksBoard.importAllStoryTasks.added': 'Uvezeno {count} taskova iz priča',
    'tasksBoard.importAllStoryTasks.none': 'Svi taskovi iz priča su već uvezeni',
    'tasksBoard.importAllStoryTasks.failed': 'Uvoz taskova iz priča nije uspeo',
    'tasksBoard.stats.total': 'Ukupno: {count}',
    'tasksBoard.stats.filtered': '(filtrirano)',
    'tasksBoard.focus.title': 'Fokusirani prikaz',
    'tasksBoard.focus.titleWithStory': 'U fokusu: {story}',
    'tasksBoard.focus.fallbackStory': 'Priča',
    'tasksBoard.focus.label': 'Fokus: {story}',
    'tasksBoard.empty.dropHere': 'Prevucite stavke ovde',
    'tasksBoard.share.notAvailable': 'Share link nije dostupan (share storage nije podešen).',
    'tasksBoard.share.copied': 'Link je kopiran',
    ...
    'tasksBoard.categories.platform': 'Platforma',
    'tasksBoard.categories.partners': 'Partneri',
    'tasksBoard.categories.ops': 'Operacije',

    'tasksBoard.impact.high': 'Visok',
    'tasksBoard.impact.medium': 'Srednji',
    'tasksBoard.impact.low': 'Nizak',
    ...
    // Sales Agents Monitor
    'salesAgentsMonitor.section': 'Retention',
    'salesAgentsMonitor.title': 'Monitor Prodajnih Agenata',
    'salesAgentsMonitor.subtitle': 'Jednostavan dashboard za pracenje performansi prodajnih agenata.',
    'salesAgentsMonitor.dataSource': 'Izvor podataka',
    'salesAgentsMonitor.filterByAgent': 'Filtriraj po agentu',
    'salesAgentsMonitor.focusSalesTeamOnly': 'Fokus samo na trenutni Sales tim',
    'salesAgentsMonitor.searchAgents': 'Pretrazi agente...',
    'salesAgentsMonitor.kpi.agents': 'Agenti',
    'salesAgentsMonitor.kpi.activeClients': 'Aktivni klijenti',
    'salesAgentsMonitor.kpi.totalDeposit': 'Ukupni depozit',
    'salesAgentsMonitor.kpi.totalNet': 'Ukupni neto',
    'salesAgentsMonitor.kpi.avgNetPerAgent': 'Prosecni neto / agent',
    'salesAgentsMonitor.timeframe.all': 'Sve vreme',
    'salesAgentsMonitor.timeframe.last12': 'Poslednjih 12 meseci',
    'salesAgentsMonitor.top6.title': 'Top 6 Najboljih Agenata',
    'salesAgentsMonitor.top6.subtitle': 'po neto performansama',
    'salesAgentsMonitor.top6.empty': 'Nema dostupnih ranking podataka.',
    'salesAgentsMonitor.charts.deposits.title': 'Depoziti',
    'salesAgentsMonitor.charts.deposits.subtitle': 'Top performeri po ukupnim depozitima',
    'salesAgentsMonitor.charts.closedPl.title': 'Closed P&L',
    'salesAgentsMonitor.charts.closedPl.subtitle': 'Top performeri po zatvorenom profit/loss',
    'salesAgentsMonitor.charts.empty': 'Nema podataka',
    'salesAgentsMonitor.table.rank': '#',
    'salesAgentsMonitor.table.agent': 'Agent',
    'salesAgentsMonitor.table.clients': 'Klijenti',
    'salesAgentsMonitor.table.active': 'Aktivni',
    'salesAgentsMonitor.table.deposit': 'Depozit',
    'salesAgentsMonitor.table.wd': 'Isplate',
    'salesAgentsMonitor.table.net': 'Neto',
    'salesAgentsMonitor.table.closedPl': 'Closed PL',
    'salesAgentsMonitor.table.trades': 'Trades',
    'salesAgentsMonitor.table.netPerClient': 'Neto / Klijent',
    'salesAgentsMonitor.table.tradesPerClient': 'Trades / Klijent',
    'salesAgentsMonitor.table.momDelta': 'MoM Delta',
    'salesAgentsMonitor.table.noAgents': 'Nema agenata za trenutne filtere.',
    'salesAgentsMonitor.backToTop': 'Nazad na vrh',
    'salesAgentsMonitor.backToTopButton': '↑ Nazad na vrh',
    'salesAgentsMonitor.tooltip.rank': 'Pozicija na rang listi po neto vrednosti (opadajuce).',
    'salesAgentsMonitor.tooltip.agent': 'Prodajni agent dodeljen portfoliju klijenata.',
    'salesAgentsMonitor.tooltip.clients': 'Ukupan broj klijenata dodeljenih agentu.',
    'salesAgentsMonitor.tooltip.active': 'Klijenti sa bar jednom trgovinom u izabranom periodu.',
    'salesAgentsMonitor.tooltip.deposit': 'Zbir svih depozita klijenata agenta.',
    'salesAgentsMonitor.tooltip.wd': 'Zbir svih isplata klijenata agenta.',
    'salesAgentsMonitor.tooltip.net': 'Neto tok gotovine: depoziti minus isplate.',
    'salesAgentsMonitor.tooltip.closedPl': 'Realizovani profit/loss sa zatvorenih trgovina.',
    'salesAgentsMonitor.tooltip.trades': 'Ukupan broj izvrsenih trgovina.',
    'salesAgentsMonitor.tooltip.netPerClient': 'Prosecna neto vrednost po klijentu.',
    'salesAgentsMonitor.tooltip.tradesPerClient': 'Prosecan broj trgovina po klijentu.',
    'salesAgentsMonitor.tooltip.momDelta': 'Razlika izmedju neto vrednosti poslednjeg i prethodnog perioda.',
    'salesAgentsMonitor.personal.selectPlaceholder': 'Izaberi jednog agenta...',
    'salesAgentsMonitor.personal.title': 'Lični dashboard — {name}',
    'salesAgentsMonitor.personal.subtitle': 'Fokusiran prikaz performansi i preporuka',
    'salesAgentsMonitor.personal.noData': 'Nema ličnih podataka za izabranog agenta.',
    'salesAgentsMonitor.personal.kpi.clients': 'Klijenti',
    'salesAgentsMonitor.personal.kpi.activeRate': 'Stopa aktivnih',
    'salesAgentsMonitor.personal.kpi.net': 'Neto',
    'salesAgentsMonitor.personal.kpi.netPerClient': 'Neto / Klijent',
    'salesAgentsMonitor.personal.kpi.momDelta': 'MoM Delta',
    'salesAgentsMonitor.personal.insight.decline.title': 'Značajan pad',
    'salesAgentsMonitor.personal.insight.decline.desc': 'Mesečni neto je niži za {pct}% u odnosu na prethodni period.',
    'salesAgentsMonitor.personal.insight.attrition.title': 'Rizik aktivnosti klijenata',
    'salesAgentsMonitor.personal.insight.attrition.desc': 'Samo {pct}% klijenata je trenutno aktivno.',
    'salesAgentsMonitor.personal.insight.volume.title': 'Veliki obim, mali prinos',
    'salesAgentsMonitor.personal.insight.volume.desc': 'Puno trgovina, ali nizak neto po klijentu.',
    'salesAgentsMonitor.personal.insight.negative.title': 'Negativan finansijski signal',
    'salesAgentsMonitor.personal.insight.negative.desc': 'Neto ili Closed P&L je ispod nule.',
    'salesAgentsMonitor.personal.insight.good.title': 'Stabilan momentum',
    'salesAgentsMonitor.personal.insight.good.desc': 'Nema kritičnih signala u ovom periodu.',
    'salesAgentsMonitor.personal.ctaTitle': 'Izaberi agenta da otvoriš lični dashboard',
    'salesAgentsMonitor.personal.ctaSubtitle': 'Koristi izbor agenta iznad da pređeš sa pregleda na individualne uvide.',
    'salesAgentsMonitor.alerts.title': 'Upozorenja o performansama',
    'salesAgentsMonitor.alerts.subtitle': 'Agenti koji zahtevaju paznju',
    'salesAgentsMonitor.alerts.empty': 'Svi agenti imaju dobru performansu — nema upozorenja.',
    'salesAgentsMonitor.alerts.decline.title': 'Znacajno smanjenje',
    'salesAgentsMonitor.alerts.decline.desc': 'Mesecni neto smanjen za {pct}% — preispitaj strategiju',
    'salesAgentsMonitor.alerts.attrition.title': 'Odliv klijenata',
    'salesAgentsMonitor.alerts.attrition.desc': '{lost} klijenata postali neaktivni',
    'salesAgentsMonitor.alerts.volume.title': 'Veliki obim, mali prinos',
    'salesAgentsMonitor.alerts.volume.desc': 'Mnogo trgovina ali neto po klijentu ispod proseka',
    'salesAgentsMonitor.alerts.negative.title': 'Negativne performanse',
    'salesAgentsMonitor.alerts.negative.desc': 'Neto ili Closed P&L ispod nule',

    // Platform Usage & Billing
    'platformUsageBilling.title': 'Platform Usage & Billing',
    'platformUsageBilling.subtitle':
      'Pratite korišćenje provajdera i povežite aktivne naloge sa org chart-om.',
    'platformUsageBilling.subtitleBillingOnly':
      'Finansijski pregled: mesečne fakture (još bez povezivanja sa org chart-om).',
    'platformUsageBilling.provider': 'Provider',
    'platformUsageBilling.period': 'Period',
    'platformUsageBilling.period.last7': 'Poslednjih 7 dana',
    'platformUsageBilling.period.last15': 'Poslednjih 15 dana',
    'platformUsageBilling.period.last30': 'Poslednjih 30 dana',
    'platformUsageBilling.period.last60': 'Poslednjih 60 dana',
    'platformUsageBilling.dataSource': 'Izvor podataka:',
    'platformUsageBilling.month': 'Mesec',
    'platformUsageBilling.invoiceForMonth': 'Faktura ({month})',
    'platformUsageBilling.dataNotAvailable': 'Podaci nisu dostupni',
    'platformUsageBilling.usersNotAvailable': 'users.csv nije dostupan',
    'platformUsageBilling.usersSource': 'Korisnici:',
    'platformUsageBilling.invoiceLink': 'Invoice PDF',
    'platformUsageBilling.invoice.month': 'Mesec fakture',
    'platformUsageBilling.invoice.total': 'Ukupno za uplatu',
    'platformUsageBilling.invoice.invoiceNo': 'Faktura',
    'platformUsageBilling.invoice.date': 'Datum fakture',
    'platformUsageBilling.invoice.due': 'Rok',
    'platformUsageBilling.invoice.vat': 'PDV',
    'platformUsageBilling.invoice.items': 'Stavke',
    'platformUsageBilling.invoice.sku': 'SKU',
    'platformUsageBilling.invoice.qty': 'QTY',
    'platformUsageBilling.invoice.unitPrice': 'Jedinična cena',
    'platformUsageBilling.invoice.amount': 'Iznos',
    'platformUsageBilling.providerInactive': 'Provider još nije aktivan.',
    'platformUsageBilling.providerInactiveHint':
      'Trenutno je povezan samo Skale. Izaberite Skale da vidite korišćenje i uticaj na naplatu.',
    'platformUsageBilling.loading': 'Učitavanje korisnika…',

    'platformUsageBilling.kpi.totalUsers': 'Ukupno korisnika',
    'platformUsageBilling.kpi.systemActive': 'Aktivni CRM korisnici',
    'platformUsageBilling.kpi.active30': 'Korisnici aktivni u poslednjih {days} dana',
    'platformUsageBilling.kpi.activeNoLogin30': 'Neaktivni korisnici (>{days} dana bez logina)',

    'platformUsageBilling.orgImpact.eyebrow': 'Uticaj na Org Chart',
    'platformUsageBilling.orgImpact.title': 'Tabela uticaja na Org Chart',
    'platformUsageBilling.orgImpact.orgNode': 'Odeljenje',
    'platformUsageBilling.orgImpact.teamLeader': 'Team leader',
    'platformUsageBilling.orgImpact.total': 'Ukupno korisnika',
    'platformUsageBilling.orgImpact.active30': 'Aktivni poslednjih {days} dana',
    'platformUsageBilling.orgImpact.dormant': 'Neaktivni (>{days} dana)',
    'platformUsageBilling.orgImpact.action': 'Predložena akcija',
    'platformUsageBilling.orgImpact.clickHint':
      'Kliknite na odeljenje da proširite detalje ispod reda.',
    'platformUsageBilling.orgImpact.openDepartment': 'Otvori odeljenje',

    'platformUsageBilling.departmentDetails.eyebrow': 'Detalji odeljenja',
    'platformUsageBilling.departmentDetails.title': 'Odeljenje',
    'platformUsageBilling.departmentDetails.noneSelected': 'Izaberite odeljenje iz tabele iznad.',
    'platformUsageBilling.departmentDetails.clear': 'Očisti',
    'platformUsageBilling.departmentDetails.active': 'Aktivni korisnici',
    'platformUsageBilling.departmentDetails.notActive': 'Neaktivni korisnici',

    'platformUsageBilling.billing.eyebrow': 'Potencijalna optimizacija naplate',
    'platformUsageBilling.billing.title': 'Potencijalna optimizacija naplate',
    'platformUsageBilling.billing.dormantBillable': 'Neaktivni korisnici',
    'platformUsageBilling.billing.dormantBillableHint':
      'Potencijalno naplativi neaktivni korisnici',
    'platformUsageBilling.billing.monthly': 'Mesečni uticaj',
    'platformUsageBilling.billing.quarterly': 'Kvartalni uticaj',
    'platformUsageBilling.billing.yearly': 'Godišnji uticaj',
    'platformUsageBilling.billing.rate': '$65 po korisniku mesečno',
    'platformUsageBilling.billing.latestInvoice': 'Poslednja faktura',

    'platformUsageBilling.usersTable.eyebrow': 'Korisnici',
    'platformUsageBilling.usersTable.title': 'Tabela korisnika',
    'platformUsageBilling.usersTable.userName': 'Ime korisnika',
    'platformUsageBilling.usersTable.orgNode': 'Odeljenje',
    'platformUsageBilling.usersTable.role': 'Uloga',
    ...
    // Creolabs
    'creolabs.title': 'Creolabs',
    'creolabs.subtitle': 'Mesečni pregled (Top 50 rang liste).',
    'creolabs.period': 'Period',
    'creolabs.year': 'Year',
    'creolabs.month': 'Month',
    'creolabs.all': 'All',
    ...
    'creolabs.rowsSummary': 'Rows: {shown} of {total}',
    'creolabs.periods': 'Periods',
    'creolabs.search.placeholder': 'Pretraži klijenta…',
    'creolabs.search.ariaLabel': 'Pretraži klijenta',
    'creolabs.empty': 'Nema rezultata za ovaj period.',
    'creolabs.errorTitle': 'Nije moguće učitati Creolabs',
    ...
    'common.risk.low': 'Nizak',
    'common.risk.medium': 'Srednji',
    'common.risk.high': 'Visok',
    ...
    'upload.response.openLog': 'Otvori log',
    'upload.emptyDash': '—',
    ...
    'upload.result.ok': 'OK',
    'upload.result.failed': 'Neuspešno',
    'upload.result.type': 'Tip',
    'upload.result.updated': 'Ažurirano',
    'upload.result.rawBackup': 'Raw backup',
    'upload.result.logFile': 'Log fajl',
    'upload.result.sanitizer': 'Sanitizer',
    'upload.result.converted': 'Konvertovano',
    'upload.result.yes': 'Da',
    'upload.result.no': 'Ne',
    'upload.result.convertedFrom': 'Konvertovano iz',
    'upload.result.convertedSheet': 'List',
    'upload.result.summary': 'Sažetak',
    'upload.result.summary.existing': 'Postojeće',
    'upload.result.summary.added': 'Dodato',
    'upload.result.summary.updated': 'Ažurirano',
    ...
    'upload.result.postProcessing': 'Post-obrada',
    'upload.result.status': 'Status',
    'upload.result.postProcessingDetails': 'Detalji',
    'upload.result.logsSaved': 'Puni logovi su sačuvani u fajlu.',
    'upload.result.verboseMode': 'Savet: dodaj ?verbose=1 za detaljne logove.',
    'upload.result.logs': 'Logovi',
    ...
    'support.details.partnerProfile.label': 'Cellxpert',
    'support.details.partnerProfile.hint': 'Otvori u Cellxpert ({customerId})',
    'support.details.skale.label': 'Skale',
    'support.details.skale.hint': 'Otvori u Skale ({recordId})',
    ...
    'support.details.statusFallback': 'Status',
    'support.details.country': 'Država',
