      ...
      <div className="rounded-2xl border border-white/10 bg-gray-700/70 p-4 shadow-sm">
        <div className="flex items-center justify-between gap-2 text-xs text-gray-400">
          ...
          <InfoTooltip
            ...
            content={
              <div>
                <div className="font-semibold text-gray-100">{t('traderPoints.workingSet.tooltip.rules.title')}</div>
        ...
        <div className="mt-1 text-3xl font-black tracking-tight text-gray-100">
          ...
          <span className="ml-2 text-sm font-semibold text-gray-400">/ {stats.totalUsers.toLocaleString()} ({pct.toFixed(1)}%)</span>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-gray-700/70 p-4 shadow-sm">
        <div className="flex items-center justify-between gap-2 text-xs text-gray-400">
          ...
          <InfoTooltip
            ...
            content={
              <div>
                <div className="font-semibold text-gray-100">{t('traderPoints.workingSet.tooltip.positions.title')}</div>
                <div className="mt-1">{t('traderPoints.workingSet.tooltip.positions.desc')}</div>
              </div>
            }
          />
        </div>
        <div className="mt-1 text-3xl font-black tracking-tight text-gray-100">{stats.avgPositionsCount.toFixed(0)}</div>
      ...
      <div className="rounded-2xl border border-white/10 bg-gray-700/70 p-4 shadow-sm">
        <div className="flex items-center justify-between gap-2 text-xs text-gray-400">
          ...
          <InfoTooltip
            ...
            content={
              <div>
                <div className="font-semibold text-gray-100">{t('traderPoints.workingSet.tooltip.ppd.title')}</div>
        ...
        <div className="mt-1 text-3xl font-black tracking-tight text-gray-100">{stats.positionsPerDayMedianZoneMean.toFixed(2)}</div>
        <div className="text-xs text-gray-400 mt-1">
      ...
      <div className="rounded-2xl border border-white/10 bg-gray-700/70 p-4 shadow-sm">
        <div className="flex items-center justify-between gap-2 text-xs text-gray-400">
          ...
          <InfoTooltip
            ...
            content={
              <div>
                <div className="font-semibold text-gray-100">{t('traderPoints.workingSet.tooltip.lifetime.title')}</div>
        ...
        <div className="mt-1 text-3xl font-black tracking-tight text-gray-100">{stats.avgAccountAgeDays.toFixed(0)}</div>
        <div className="text-xs text-gray-400 mt-1">
