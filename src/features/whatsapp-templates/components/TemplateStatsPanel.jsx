    ...
    <section className="space-y-3 rounded-2xl border border-gray-600 bg-linear-to-br from-gray-700/95 via-gray-700/85 to-gray-900/90 p-4 shadow-2xl shadow-black/20">
      <div className="rounded-xl border border-gray-600 bg-gray-700/70 p-4">
        <div className="flex items-start justify-between gap-2">
          <div>
            <h2 className="text-lg font-semibold text-gray-100">Performance & statistics</h2>
            <p className="text-xs text-gray-400">Executive view for template decision-making</p>
          </div>
      ...
      <div className="rounded-xl border border-amber-400/20 bg-amber-500/8 p-3 text-xs text-amber-100">
        KPIs shown here are based on Convrs callbacks and tracked mids. Public Convrs API does not
        expose historical template analytics, audience breakdowns or previous-period trend series.
      </div>
