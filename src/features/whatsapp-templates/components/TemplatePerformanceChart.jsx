export default function TemplatePerformanceChart({
  trend,
  period = 'last7Days',
  unavailableReason = '',
}) {
  ...
  if (!points.length) {
    return (
      <section className="rounded-xl border border-gray-600 bg-gray-700/70 p-4">
        <h3 className="text-sm font-semibold text-gray-200">Performance trend</h3>
        <p className="mt-3 text-sm text-gray-400">
          {unavailableReason || 'No trend data available.'}
        </p>
      </section>
    )
  }
  ...
  return (
    <section className="rounded-xl border border-gray-600 bg-gray-700/70 p-4">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-gray-200">Performance trend chart</h3>
